...
02. Clone the repository:
    ...
    ```console
    git clone --recursive https://github.com/baberthal/prezto.git "${ZDOTDIR:-$HOME}/.zprezto"
    ```
    ...
    <details>
      ...
      - Clone the repository:
        ...
        ```console
        git clone --recursive https://github.com/baberthal/prezto.git "${ZDOTDIR:-${XDG_CONFIG_HOME:-$HOME/.config}/zsh}/.zprezto"
        ```
